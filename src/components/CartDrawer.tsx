                  ...
                  <div className="flex flex-col space-y-2.5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`relative overflow-hidden py-3 px-3 rounded-2xl border-2 text-sm font-bold transition-all flex flex-col items-center justify-center gap-1.5 ${deliveryMethod === 'PICKUP'
                      ...
                      <button
                        ...
                        className={`relative overflow-hidden py-3 px-3 rounded-2xl border-2 text-sm font-bold transition-all flex flex-col items-center justify-center gap-1.5 ${deliveryMethod === 'DELIVERY'
                          ? 'border-primary-500 bg-primary-50 text-primary-600 shadow-sm'
                          : 'border-gray-100 bg-white text-gray-500 hover:border-gray-200 hover:bg-gray-50'
                          }`}
                      >
